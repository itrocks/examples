<?php
namespace ITRocks\Examples\Programmer;

/**
 * Top 50 Programming Quotes of All Time
 *
 * @link http://www.junauza.com/2010/12/top-50-programming-quotes-of-all-time
 * Thanks to Jun Auza for bringing us this piece of programmer's life
 */
class Top_Quotes
{
	...
	const QUOTES = [
		...
		44 => [
			"I have always wished for my computer to be as easy to use as my telephone; my wish has come"
			. " true because I can no longer figure out how to use my telephone.",
			'Bjarne Stroustrup'
		],
		43 => [
			"Computer science education cannot make anybody an expert programmer any more than studying"
			. " brushes and pigment can make somebody an expert painter.",
			'Eric S. Raymond'
		],
		42 => [
		...
		37 => [
			"In the one and only true way. The object-oriented version of 'Spaghetti code' is, of course,"
			. " 'Lasagna code'. (Too many layers).",
			'Roberto Waltman'
		],
		36 => [
			"FORTRAN is not a flower but a weed — it is hardy, occasionally blooms, and grows in every"
			. " computer.",
			'Alan J. Perlis'
		],
		35 => [
		...
		34 => [
			"In My Egotistical Opinion, most people's C programs should be indented six feet downward and"
			. " covered with dirt.",
			'Blair P. Houghton'
		],
		33 => [
			"When someone says: 'I want a programming language in which I need only say what I wish"
		...
		28 => [
			"Perfection [in design] is achieved, not when there is nothing more to add, but when there is"
		...
		24 => [
			"PHP is a minor evil perpetrated and created by incompetent amateurs, whereas Perl is a great"
			. " and insidious evil, perpetrated by skilled but perverted professionals.",
			'Jon Ribbens'
		],
		23 => [
		...
		18 => [
			"The best programmers are not marginally better than merely good ones. They are an"
			. " order-of-magnitude better, measured by whatever standard: conceptual creativity, speed,"
			. " ingenuity of design, or problem-solving ability.",
			'Randall E. Stross'
		],
		17 => [
			"If McDonalds were run like a software company, one out of every hundred Big Macs would give"
			. " you food poisoning, and the response would be, ‘We’re sorry, here’s a coupon for two"
			. " more.‘",
			'Mark Minasi'
		],
		16 => [
		...
		15 => [
			"Computer system analysis is like child-rearing; you can do grievous damage, but you cannot"
			. " ensure success.",
			'Tom DeMarco'
		],
		14 => [
		...
		7 => [
			...
			. " top of each other, with no structural integrity, but just done by brute force and"
			. " thousands of slaves.",
			'Alan Kay'
		],
		6 => [
	 ...
	 *
	 * @return string[] [0 => quote, 1 => author]
	 */
